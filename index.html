...
/**
 * Daily Competition – 5‑Player Line Chart
 *
 * ✅ 5 players (editable names)
 * ✅ X axis = time (days), Y axis = points
 * ✅ Optional toggle to flip axes (points on X)
 * ✅ Toggle daily vs cumulative points
 * ✅ Quick entry form + inline table editing
 * ✅ LocalStorage persistence (no backend)
 * ✅ Export/Import JSON for easy backup between friends (includes colors)
 */
...
export default function DailyCompetitionChart() {
